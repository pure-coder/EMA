...
import {ptDeleteExercise, ptGetClientProgression} from "../../../redux/actions/ptProfileActions";
...
export default connect(stateToProps, {ptDeleteExercise, ptGetClientProgression})(withRouter(GraphComp));
