...
import {clientGetProgression} from "../../../redux/actions/clientProfileActions";
import {ptGetClientProgression, clearErrors, clearSuccess} from "../../../redux/actions/ptProfileActions";
...
class Graphs extends Component {
    ...
    render() {
        ...
        if(isEmpty(this.props.authenticatedUser.user)){
            ...
            const graphs = Data.map(graph => {
                if(graph.metrics.length > 1){
                    ...
                    return (
                        ...
                        <div className="graphs card shadow-lg mb-5" key={graph._id}>
            ...
            return (
                <div id="Progression" className="Progression card shadow-lg Progression_head mb-5">
